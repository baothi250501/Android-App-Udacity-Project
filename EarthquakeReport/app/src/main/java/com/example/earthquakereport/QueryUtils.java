...
public final class QueryUtils {
    ...
    public static ArrayList<EarthquakeEvent> extractEarthquakes(){
        ...
        try {
            ...
            JSONArray earthquakeEventArray = baseJsonResponse.getJSONArray(("features"));

            //Loop through each feature in the array
            for( int i = 0; i < earthquakeEventArray.length(); ++i){

                //Get earthquake JSONObject at position i
                JSONObject currentEarthquakeEvent = earthquakeEventArray.getJSONObject(i);
                ...
                EarthquakeEvent earthquakeEvent = new EarthquakeEvent(magnitude, location, timeMilliseconds, url);
